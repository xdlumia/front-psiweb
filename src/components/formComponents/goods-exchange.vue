...
<template>
  <div>
    <form-card title="换货商品">
      ...
      >
        <el-table-column fixed label="操作" min-width="100" prop="cityName" show-overflow-tooltip>
          <template>
            <span class="el-icon-circle-plus"></span>
            <span class="el-icon-error"></span>
          </template>
        </el-table-column>
        <el-table-column label="商品编号" min-width="140" prop="title" show-overflow-tooltip>
          <template>
            <commodity-selector></commodity-selector>
          </template>
        </el-table-column>
        <el-table-column label="商品名称" min-width="100" prop="cityName" show-overflow-tooltip>
          <template>
            <commodity-selector></commodity-selector>
          </template>
        </el-table-column>
        <el-table-column label="换入数量" min-width="140" prop="title" show-overflow-tooltip>
          <template>
            <el-input size="mini" v-model="data"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="换入金额" min-width="140" prop="title" show-overflow-tooltip>
          <template>
            <el-input size="mini" v-model="data"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="税率" min-width="140" prop="title" show-overflow-tooltip></el-table-column>
        <el-table-column label="含税金额" min-width="140" prop="title" show-overflow-tooltip></el-table-column>
        <el-table-column label="商品图片" min-width="100" prop="cityName" show-overflow-tooltip></el-table-column>
