 ...
 * @LastEditors: web.王晓冬
 * @LastEditTime: 2020-01-03 11:17:53
 * @Description: 基本信息 1
 */
<template>
  ...
  data() {
    return {
      ...
      items: [
        ...
        { label: '客户责任人', prop: 'responsibleUser', type: 'select', rules: [{ required: false }], dicName: 'PSI_KHGL_LY', },
        { label: '客户关联', prop: 'customerAssociated', type: 'autocomplete', rules: [{ required: false }], dicName: 'PSI_KHGL_LY', },
