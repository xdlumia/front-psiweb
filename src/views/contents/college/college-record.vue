...
<template>
    <div>
        ...
        <d-table
            ...
            style="height:460px"
            >
            <el-table-column  prop="" align="center" width="80" >
                <template slot-scope="scope">
                    <span v-if="scope.row.isRead==0" class="d-text-red f12">new</span>
                </template>
</el-table-column>
<el-table-column show-overflow-tooltip prop="wechatName" align="center" label="微信昵称" min-width="180"></el-table-column>
<el-table-column show-overflow-tooltip prop="userPhone" align="center" label="客户电话" min-width="180"></el-table-column>
