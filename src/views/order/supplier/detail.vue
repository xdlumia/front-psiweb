 ...
 * @LastEditors: 赵伦
 * @LastEditTime: 2020-01-14 15:21:33
 * @Description: 供应商编号
*/
<template>
  <sideDetail
  ...
  >
    ...
    <el-tabs class="wfull hfull tabs-view" v-model="activeTab">
      ...
      <el-tab-pane label="应收账单" name="payreceived">
        <FullscreenWrap v-if="isDataReady&&tabStatus.payreceived">
          <FinanceReceivable :button="false" :params="{page:1,limit:15,clientId:detail.id,clientType:1}" />
        </FullscreenWrap>
      </el-tab-pane>
