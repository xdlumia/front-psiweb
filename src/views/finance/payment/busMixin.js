 ...
 * @LastEditors: 赵伦
 * @LastEditTime: 2019-11-22 18:48:06
 * @Description: 关联业务辅助
 */
    ...
    data() {
        return {
            ...
            busInfo: {
                // 销售出库单
                0: {
                    stateText: { "0": "审核中", "1": "请购处理", "2": "回收合同", "3": "已通过", "4": "完成", "5": "已驳回", "6": "终止", "-1": "新建" },
                ...
                // 销售退货单
                1: {
                    stateText: { "0": "审核中", "1": "待完成", "2": "部分完成", "3": "已完成", "4": "已驳回", "-1": "新建" },
                ...
                // 费用单
                3: {
                    stateText: { "0": "审核中", "1": "待复核", "2": "已通过", "3": "已驳回", "4": "部分分摊", "5": "已分摊", "-1": "新建" },
                ...
                // 采购入库单
                4: {
                    stateText: { "0": "新建", "1": "审核中", "3": "已通过", "4": "已完成", "5": "已驳回", "6": "已终止", },
                ...
                // 采购退货单
                5: {
                    stateText: { "0": "新建", "1": "审核中", "2": "待退货", "3": "部分退货", "4": "已退货", "5": "已驳回", },
                ...
                // 采购换货单
                6: {
                    stateText: { "0": "新建", "1": "审核中", "2": "待换货", "3": "部分换货", "4": "完成换货", "-1": "已驳回" },
