 ...
 * @LastEditors: 高大鹏
 * @LastEditTime: 2019-11-05 17:25:22
 * @Description: 新增商品
 -->
<template>
        ...
        <el-row :gutter="40">
          <el-col :span="8">
            <el-form-item label="库房名称" prop="name">
              <el-input v-model="storeRoomForm.name"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="选择员工" prop="personInChargeId">
              <employees-chosen
                v-model="employee"
                :isEdit="true"
                :multiple="false"
          ...
          <el-col :span="8">
            <el-form-item label="库房地址" prop="address">
              <el-input v-model="storeRoomForm.address"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </form-card>
