...
<template>
  <sideDetail
    ...
    title="商品导入"
  >
    <div style="height: 300px;" class="ml30 fl w30">
      ...
      <el-row style="margin-top:40px">
        <el-col :span="12">
          ...
          <el-upload
            ...
            :action="window.g.ApiUrl.seeGoodsService + '/goods/jxc/upload'"
            :headers="headers"
            :data="PreviewFileVo"
...
style="width: 100%">
            ...
            <el-table-column prop="goodsCode" label="物品编码"></el-table-column>
          </el-table>
        </div>
...
export default {
  ...
  methods: {
    ...
    downLoad() { // 下载
      ...
      window.location.href = window.g.ApiUrl.seeGoodsService + '/goods/jxc/downloadTemplet?' + params
    },
