const MOCK_ADDRESS = '/mock/5dbcfaabbc54fc3da273f1dc/see-psi-wms-service'
...
export default {
  ...
  // 根据销售单code查对应商品信息
  wmsassembleorderGetBySalesSheetCode: {
    'url': '/wmsassembleorder/getBySalesSheetCode/{salesSheetCode}',
    'mock': false
  },
