 ...
 * @LastEditors: 高大鹏
 * @LastEditTime: 2019-10-28 16:48:27
 * @Description: ip配置文件
 */
...
const baseURL = {
  ...
  seeContractService: apisUrl + 'see-contract-service', // 合同服务韩延峰
  ...
  seeHouseConfigService: apisUrl + 'see-house-config-service', // 在这个项目里 seeHouseConfigService 的公共部分都转移到 see-baseinfo-service服务里
